...
* @see app/Http/Controllers/WebsiteController.php:244
...
* @see app/Http/Controllers/WebsiteController.php:249
* @route '/ssl/websites'
*/
...
* @see app/Http/Controllers/WebsiteController.php:349
...
* @see app/Http/Controllers/WebsiteController.php:426
...
* @see app/Http/Controllers/WebsiteController.php:435
* @route '/ssl/websites/{website}'
*/
...
* @see app/Http/Controllers/WebsiteController.php:472
...
* @see app/Http/Controllers/WebsiteController.php:642
...
* @see app/Http/Controllers/WebsiteController.php:662
...
* @see app/Http/Controllers/WebsiteController.php:718
...
* @see app/Http/Controllers/WebsiteController.php:782
...
* @see app/Http/Controllers/WebsiteController.php:513
...
* @see app/Http/Controllers/WebsiteController.php:589
...
* @see app/Http/Controllers/WebsiteController.php:1063
...
* @see app/Http/Controllers/WebsiteController.php:1124
...
* @see app/Http/Controllers/WebsiteController.php:810
...
* @see app/Http/Controllers/WebsiteController.php:844
...
* @see app/Http/Controllers/WebsiteController.php:876
...
export const transferOptions = (args: { website: number | { id: number } } | [website: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: transferOptions.url(args, options),
    method: 'get',
})

transferOptions.definition = {
    methods: ["get","head"],
...
transferOptions.url = (args: { website: number | { id: number } } | [website: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    ...
    return transferOptions.definition.url
            .replace('{website}', parsedArgs.website.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
...
const transferOptionsForm = (args: { website: number | { id: number } } | [website: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: transferOptions.url(args, options),
    method: 'get',
})
...
transferOptionsForm.head = (args: { website: number | { id: number } } | [website: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: transferOptions.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
transferOptions.form = transferOptionsForm

/**
* @see \App\Http\Controllers\WebsiteController::bulkTransferToTeam
* @see app/Http/Controllers/WebsiteController.php:1022
...
* @see app/Http/Controllers/WebsiteController.php:1200
...
const websites = {
    ...
    bulkCheck: Object.assign(bulkCheck, bulkCheck),
    details: Object.assign(details, details),
    certificateAnalysis: Object.assign(certificateAnalysis, certificateAnalysis),
    immediateCheck: Object.assign(immediateCheck, immediateCheck),
    checkStatus: Object.assign(checkStatus, checkStatus),
    history: Object.assign(history, history),
    statistics: Object.assign(statistics, statistics),
    transferToTeam: Object.assign(transferToTeam, transferToTeam),
    transferToPersonal: Object.assign(transferToPersonal, transferToPersonal),
