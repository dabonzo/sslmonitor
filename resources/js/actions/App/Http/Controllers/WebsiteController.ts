...
const WebsiteController = { index, create, store, show, edit, update, destroy, check, bulkDestroy, bulkCheck, details, certificateAnalysis, immediateCheck, checkStatus, transferToTeam, transferToPersonal, getTransferOptions, bulkTransferToTeam, bulkTransferToPersonal }
