...
<template>
    <CoverAuthLayout title="Sign in" description="Enter your email and password to login">
        <Head title="Log in" />
        ...
        >
            ...
            <div class="mb-10">
                <div class="flex justify-center gap-3">
                    ...
                    <button
                        type="button"
                        class="inline-flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-[#ef1262] to-[#4361ee] p-0 transition hover:scale-110"
                    >
